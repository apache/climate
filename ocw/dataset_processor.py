...
def subset(target_dataset, subregion, subregion_name=None, extract=True, user_mask_values=[1]):
    ...
    if hasattr(subregion, 'lat_min'):
        ...
        # this boundary check may not be necessary with the updated Bounds and subset
        #_are_bounds_contained_by_dataset(target_dataset, subregion)   # this boundary check is not necessary with the updated Bounds and subset
