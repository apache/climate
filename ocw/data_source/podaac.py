...
def load_dataset(variable ,datasetId='', datasetShortName='', name=''):
	...
	granuleName = podaac.extract_l4_granule(datasetId=datasetId, shortName=datasetShortName, path=path)
    ...
    # Removing the downloaded temporary granule before creating the OCW dataset. 
	d.close()
