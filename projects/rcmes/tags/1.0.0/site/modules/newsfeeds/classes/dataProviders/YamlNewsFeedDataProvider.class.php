<?php
require_once(MODULE . "/classes/dataProviders/NewsFeedDataProvider.class.php");
require_once(MODULE . "/classes/thirdparty/spyc-0.4.5/spyc.php");
...
class YamlNewsFeedDataProvider extends NewsFeedDataProvider {
	...
	protected function asHtml($data) {
		...
		foreach ($data as $d) {
			...
			$r .= "    <div class=\"nf_date\">{$d['date']}</div>\r\n";
