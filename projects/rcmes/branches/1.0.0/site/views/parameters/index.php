...
<div class="span-17 last" id="mainSection">
	...
	<form method="GET" action="<?php echo SITE_ROOT?>/parameterQuery.do">
		...
		<table>
		  ...
		  <tr><th>Lat. (min):</th><td><input type="text" name="latMin"/></td>
		  	  <th>Lat. (max):</th><td><input type="text" name="latMax"/></td>
		  </tr>
		  <tr><th>Lon. (min):</th><td><input type="text" name="lonMin"/></td>
		  	  <th>Lon. (max):</th><td><input type="text" name="lonMax"/></td>
		  </tr>
		  <tr>
		    <td colspan="4"><hr/>
		  ...
		  <tr><th>Start Date:</th><td><input type="text" name="timeStart"/></td>
		  	  <th>End Date :</th><td><input type="text" name="timeEnd"/></td>
		  </tr>
		  <tr>
