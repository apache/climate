...
class JobProperties(object):
    ...
    def __init__(self, workDir, cacheDir, spatialGrid, temporalGrid, gridLonStep=None, gridLatStep=None, outputFile='false', 
                 latMin=None, latMax=None, lonMin=None, lonMax=None, startDate=None, endDate=None, variableType=None):
...
class Model(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Input (keyword dictionary)::
            ...
            varaibleType - a string to indicate the variable type. this generalizes the use of precipFlat (obsolete now)
        ...
        if len(kwargs) == 6:
            ...
            #self.varaibleType = kwargs['variableType']
